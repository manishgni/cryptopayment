                    ...
                    <ul class="clearfix">
                        <li>
                            <div class="member-img">
                                <a href="<?php echo base_url('/Dashboard/User/Pool/' . $user['user_id'] . '/'); ?>">
                                    <img src="https://scootpool.uk/active.png">
                                </a>
                            ...
                            <ul class="clearfix">
                                ...
                                foreach ($users as $key => $direct) {
                                    ...
                                    <li>
                                        <div class="member-img">
                                            <a href="<?php echo base_url('/Dashboard/User/Pool/' . $direct['user_id']); ?>">
                                                <img src="https://scootpool.uk/active.png">
                                            </a>
                                        ...
                                        <ul class="clearfix">
                                            ...
                                            foreach ($direct['level_2'] as $key => $level3) {
                                                ...
                                                <li>
                                                    <div class="member-img">
                                                        <a href="<?php echo base_url('/Dashboard/User/Pool/' . $level3['user_id']); ?>">
                                                            <img src="https://scootpool.uk/active.png">
                                                        </a>
