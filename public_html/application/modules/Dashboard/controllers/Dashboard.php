...
//    }
    ...
    public function forgot_password() {
        ...
        if ($this->input->server('REQUEST_METHOD') == 'POST') {
            ...
            if (!empty($user)) {
                $message = "Dear " . $user['first_name'] . ' ' . $user['last_name'] . '  password for Your Account is ' . $user['password'];
                ...
                $this->session->set_flashdata('message', 'Password Sent On Your Mobile No.');
            } else {
                $this->session->set_flashdata('message', 'Invalid User ID');
            }
        }
