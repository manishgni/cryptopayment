 ...
 <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <span class="">Approve Withdraw Request </span>
          </section>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card card-body">
              <div class="card-header">
                  <form method="GET" action="<?php echo base_url('Admin/Withdraw/approveWithdraw/'.$status.'/');?>">
                      <div class="row">
                          <div class="col-3">
    ...
    //                        pr($request);
                            ...
                            <tr>
                                ...
                                <td><?php echo $request['jolo']['joloorderid']; ?></td>
                                <td><?php echo $request['jolo']['orderid']; ?></td>
                                <td>
