  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">This Month Jackpot Bonus ($<?php echo $jackpot_bonus['jackpot_bonus'] / 100;?>)</h1><br>
            <h2>Total Send $<?php echo $jackpot_bonus_send['jackpot_bonus_send'];?></h2>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Payout Management</li>
              <li class="breadcrumb-item active">Send Jackpot Bonus</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<script>
  ...
  $(document).on('submit','#walletForm',function(){
      if (confirm('Do you want to Send Jackpot bonus on This Account?')) {
