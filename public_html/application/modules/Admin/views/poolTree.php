                    ...
                    <ul class="clearfix">
                        <li>
                            <div class="member-img">
                                <a href="<?php echo base_url('/Admin/Management/Pool/' . $user['user_id'] . '/'); ?>">
                            ...
                            <ul class="clearfix">
                                ...
                                foreach ($users as $key => $direct) {
                                    ...
                                    <li>
                                        <div class="member-img">
                                            <a href="<?php echo base_url('/Admin/Management/Pool/' . $direct['user_id']); ?>">
                                                <img src="<?php echo base_url('uploads/active.png');?>">
                                            </a>
                                        ...
                                        <ul class="clearfix">
                                            <?php
                                            foreach ($direct['level_2'] as $key2 => $level3) {
                                                //pr($level3);
                                                // die;
                                                ?>
                                                <li>
                                                    <div class="member-img">
                                                        <a href="<?php echo base_url('/Admin/Management/Pool/' . $level3['user_id']); ?>">
                                                            <img src="<?php echo base_url('uploads/active.png');?>">
                                                        </a>
                                                        <span><?php echo $level3['user_id']; ?></span><br>
                                                        <span><?php $name = getName($level3['user_id']); echo $name['name'];?></span>
                                                    </div>
