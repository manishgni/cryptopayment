...
.alert.alert-danger.alert-rounded {
    position: relative;
    top: 17px;
    left: 34px;
}
@media screen and (max-width: 767px){
...

 {
  line-height: 1.9em;
  background: #aaa
    url(https://cdn.pbrd.co/images/HxiLKj4.jpg)
  ...
  filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(
      src="https://cdn.pbrd.co/images/HxiLKj4.jpg",
      sizingMethod="scale"
    );
  -ms-filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://cdn.pbrd.co/images/HxiLKj4.jpg', sizingMethod='scale')";
}
.messageBox {
  padding: 1em;
  background: #002e3666;
                      ...
                      <div class="row">
                        ...
                        <div class="card">
                          <div class="card-body">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h5 class="panel-title">Account Detail</h5>
                                ...
                                <div class="panel-body">
                                    <p class="desc"></p>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <input type="text" class="form-control" name="tron" value="<?php echo $user_bank['tron'];?>" placeholder="Enter Tron Details">
                                        </div>
                                     <!-- <div class="form-group" style="display:none">
                        ...
                        <div class="col-md-12 card" style="display: none;">
                          <div class="card-body">
                            ...
                            <div class="panel-body w-100 gtdtf " style="display:none">
