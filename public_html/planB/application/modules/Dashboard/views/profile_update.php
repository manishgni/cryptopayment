                  ...
                  <div class="tab-content p-0">
                      ...
                      <div class="row">
                        ...
                        <div class="card">
                          <div class="card-body">
                             <div class="panel-heading">
                          <h5 class="panel-title">Select Profile Image</h5>
                        ...
                        <div class="top-head">
                           <div class="page-panel-heading">
                                      <h5 class="panel-title">MY PERSONAL INFORMATION</h5>
                                      <?php echo $this->session->flashdata('message');?>
                                  </div>
                        </div>
                                ...
                                <table class="table table-profile">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="value">
                                                <input type="name" class="form-control" value="<?php echo $userinfo->name;?>" name="name">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <?php if($userinfo->email_verify_status == 1){
                                                            echo '<button class="btn btn-success btn-sm">Verified</button>';
                                                        }else{
                                                            echo '<input type="text" class="form-control" value="" name="otp" id="otp" placeholder="Enter OTP" required=""></div><div class="col-md-3"><a class="btn btn-warning btn-sm" id="generate_otp" onclick="generateOtp();">Generate OTP for Verification</a><button type="button" class="btn btn-xs btn-primary" id="submit_otp" style="display:none;" onclick="verify_email();">Submit</button>';
                                                        } ?>
                                         ...
                                         <tr>
                                            ...
                                            <td class="value">
                                                <select name="country" class="form-control" id = "allcountry" >
                                                        <?php foreach($countries as $key => $value){
                                                            if($userinfo->country == $value['name']){
                                                            echo '<option selected value="'.$value['name'].'"selected>'.$value['name'].'</option>';
                                                        }else{
                                        ...
                                        <tr>
                                            <td class="field">Country Code</td>
                                            <td class="value">
                                            <input type="tel" class="form-control" name="phonecode" value="<?php echo $userinfo->country_code; ?>" required id="countryCode1" readonly= "">
   ...
   <tr>
                                     ...
                                     <!--    <tr>
                                       ...
                                       <!--  <tr>
                                            ...
                                            <td class="value">
                                                <input type="text" class="form-control" value="<?php echo $bankinfo->nominee;?>" name="nominee" placeholder="Nominee Name">
                                            </td>
                                        </tr> -->
                                        ...
                                        <!-- <tr>
                                            ...
                                            <td class="value">
                                                 <input type="text" class="form-control" value="<?php// echo $bankinfo->nommanie_relation;?>" name="nommanie_relation" placeholder="Nommanie Relation"> 
...
<script>
    ...
    function generateOtp() {
        fetch("<?php echo base_url('Dashboard/Profile/generateOtp'); ?>", {
           method: "GET",
           headers: {
    ...
    function verify_email() {
        ...
        fetch("<?php echo base_url('Dashboard/Profile/verify_email/'); ?>"+otp, {
           method: "GET",
           headers: {
             "X-Requested-With": "XMLHttpRequest"
           },
