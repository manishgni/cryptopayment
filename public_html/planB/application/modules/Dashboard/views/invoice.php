          ...
          <div class="row">
                              ...
                              <tbody>
                                  <tr>
                                      <td><address>
                                              ...
                                              <?php echo $siteInfo['address']; ?> </address>
                                          <b>Telephone:</b> <?php echo $siteInfo['phone'];?><br>
                                          <b>E-Mail:</b> <?php echo $siteInfo['email']; ?><br>
                                          <b>Web Site:</b> <a href="#"><?php  echo base_url(); ?></a></td>
                                      <td><b>Date Added:</b> <?php echo date('Y-m-d  H:i:s') ?><br>
                                          <b>Order ID:</b> <?php  echo strtotime($userInfo['topup_date']); ?><br>
                          ...
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                  <tr>
                                      <?php
                                        echo '<td><address>
                                               <br> User ID: '.$userInfo['user_id'].' <br> Phone: '.$userInfo['phone'].'<br> Address: '.$userInfo['address'].'</address></td>';?>
                                        <td><address>
                  ...
                  <div class="card border-0">
                      <div class="card-body table-responsive">
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                  <tr>.
                                      <td>30x30 Gaj Plot OR <br> 20x45 Gaj Plot  <br>
                                          &nbsp;<small> - Delivery Date: 2011-04-22</small>
                                      </td>
                                      <td>Rohat, Jodhpur</td>
                                      <td class="text-right">1</td>
                                      <td class="text-right"><?php echo currency; ?> 2,50,000.00</td>
                                      <td class="text-right"><?php echo currency; ?> 2,50,000.00</td>
                                  </tr>
                                  <tr>
              ...
              <div class="col-12 col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-1 ">
                             <a href="" onclick="window.print()" class="btn btn-primary "  style="margin-left: 36px;">Print</a>
                        </div>
                    </div>
