                                                        ...
                                                        <td colspan="2" align="center">
                                                            <a href="#" class="has-tooltip">
                                                                ...
                                                                <span class="on-hover">
                                                                    ...
                                                                    Sponser ID : <?php echo $level1->sponser_id;?> <br>
                                                                    <?php $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level1->sponser_id],'name');
                                                                    echo 'Sponser Name : '.$data['name'].'<br>';
                                                                      ?>
                                                                            ...
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level2[1]->user_id).'" class="has-tooltip">
                                                                                    ...
                                                                                    <span class="on-hover">
                                                                                       ...
                                                                                       $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level2[1]->sponser_id],'name');
                                                                                    echo 'Sponser Name : '.$data['name'].'<br>
                                                                            ...
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level2[2]->user_id).'" class="has-tooltip">
                                                                                    ...
                                                                                    <span class="on-hover">
                                                                                       ...
                                                                                       $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level2[2]->sponser_id],'name');
                                                                                    echo 'Sponser Name : '.$data['name'].'<br>
                                                                            ...
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[1]->user_id).'" class="has-tooltip">
                                                                                    ...
                                                                                    <span class="on-hover">
                                                                                       ...
                                                                                       $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level3[1]->sponser_id],'name');
                                                                                    echo 'Sponser Name : '.$data['name'].'<br>
                                                                        ...
                                                                        if(!empty($level3[2]->user_id)){
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[2]->user_id).'" class="has-tooltip">
                                                                                       ...
                                                                                       $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level3[2]->sponser_id],'name');
                                                                                    echo 'Sponser Name : '.$data['name'].'<br>
                                                                            ...
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[3]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        <span class="on-hover">
                                                                                            ...
                                                                                            Sponser ID : ' .$level3[3]->sponser_id.' <br>';
                                                                                       $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level3[3]->sponser_id],'name');
                                                                                    echo 'Sponser Name : '.$data['name'].'<br>
                                                                            ...
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[4]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        <span class="on-hover">
                                                                                            ...
                                                                                            Sponser ID : ' .$level3[4]->sponser_id.' <br>';
                                                                                       $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level3[4]->sponser_id],'name');
                                                                                    echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[1]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[1]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[1]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[2]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[2]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[2]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[3]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[3]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[3]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[4]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[4]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[4]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[5]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[5]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[5]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[6]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[6]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[6]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[7]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[7]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[7]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[8]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Sponser ID : ' .$level4[8]->sponser_id.' <br>';
                                                                                                            $data = $this->User_model->get_single_record('tbl_users',['user_id' => $level4[8]->sponser_id],'name');
                                                                                                            echo 'Sponser Name : '.$data['name'].'<br>
