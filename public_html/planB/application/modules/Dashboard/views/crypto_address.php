                      ...
                      <!-- BEGIN tab-pane -->
                        ...
                        <div class="col-md-12">
                          <div class="page-panel-heading">
                                <h5 class="panel-title">Update USDT Address</h5>
                          ...
                          <div class="card-body">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <p class="desc"></p>
                                        <?php echo form_open(base_url('Dashboard/Profile/usdtaddress'),array(''));?>
                                        <div class="form-group">
                                            <label for="txtoldpass">USDT Address</label>
                                            <input type="text" class="form-control" name="usdt"  value="<?php echo $user_bank['usdt']?>" placeholder="Enter USDT Address" required="">
                                        </div>
                                        <div id="SLgPWD"></div>
