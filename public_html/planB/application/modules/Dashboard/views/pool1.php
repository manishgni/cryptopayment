                    ...
                    <ul class="clearfix">
                        <li>
                            <div class="member-img">
                                <a href="<?php echo base_url('/Dashboard/User/'.$url.'/' . $user['user_id'] . '/'); ?>">
                            ...
                            <ul class="clearfix">
                                ...
                                foreach ($users as $key => $direct) {
                                    ...
                                    <li>
                                        <div class="member-img">
                                            <a href="<?php echo base_url('/Dashboard/User/'.$url.'/'. $direct['user_id']); ?>">
                                                <img src="<?php echo base_url('uploads/')?>active.png">
                                            </a>
                                        ...
                                        <ul class="clearfix">
                                            ...
                                            foreach ($direct['level_2'] as $key => $level3) {
                                                ...
                                                <li>
                                                    <div class="member-img">
                                                        <a href="<?php echo base_url('/Dashboard/User/'.$url.'/'. $level3['user_id']); ?>">
                                                            <img src="<?php echo base_url('uploads')?>/active.png">
                                                        </a>
