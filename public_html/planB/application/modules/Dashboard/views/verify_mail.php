    ...
    <div class="account-pages pt-5">
        <div class="container">
            <div class="row justify-content-center m-2">
                ...
                <div class="col-md-6 col-lg-5 bg-white m-auto rounded">
                    <div class="card overflow-hidden">
                         <div class="forgot-heading text-center">
                          ...
                          <h3 class="page-title">Verify Email</h3>
              ...
              <?php echo form_open(base_url('Dashboard/User/email_verify/')); ?>
                      ...
                      <fieldset>
                          <div class="form-group">
                              ...
                              <div class="row-holder">
                                  <input id="SiteURL" type='email' name='email' maxlength='50' class="form-control" placeholder="Enter Email"/>
                              </div>
                          </div>
                          <div class="form-group" style="text-align: right;">
                              <button id="signupBtn" type="submit" class="btn btn-primary w-100 font-size-18" name='Submit' value='Login'>Verify </button>
                          </div>
