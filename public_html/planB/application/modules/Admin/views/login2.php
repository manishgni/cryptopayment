                ...
                <div class="login_page">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div style="background:#0878a7;border-radius: 20px;text-align: center;display: table;margin: 0px auto;max-width: 600px;padding-top: 20px;padding: 20px 20px;margin-bottom: 40px; margin-top:10px;   -webkit-box-shadow: -1px 2px 17px -2px rgba(0,0,0,0.75);
                                        ...
                                        <div class="log-box">
                                            ...
                                            <form id="login-form" action="" method="post"  style="display:block">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <div class="irs-donation-col">
                                                        <button class="btn btn-success pull-right" type="submit" id="login_button" style="display:none;">Login Now</button>
                                                    </div>
                                                    <div class="irs-donation-col">
                                                        <button class="btn btn-warning pull-right" type="button" id="otp_button" onclick="getOtp()">Get OTP</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
<script>
    function getOtp(){
        fetch("<?php echo base_url('Admin/Management/getOtp'); ?>", {
            method: "GET",
            headers: {
