                ...
                <?php echo form_open();?>
                    ...
                    <div class="form-group">
                        <label>Left Power</label>
                         <input type="text" name="leftPower" class="form-control" value="<?php echo $user['leftBusiness'];?>"/>
                        <label class="text-danger"><?php echo form_error('leftPower');?></label>
                    </div>
                    <div class="form-group">
                        <label>Right Power</label>
                         <input type="text" name="rightPower" class="form-control" value="<?php echo $user['rightBusiness'];?>"/>
