      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <span class="">All Blocked Users</span>
            </section>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">All Blocked Users</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                  <form method="GET" action="<?php echo base_url('Admin/Management/blockUsers/');?>">
                      <div class="row">
                          <!-- <div class="col-md-3">
                          ...
                          <!-- <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <input type="date" name="start" class="form-control float-right" value="<?php echo $start;?>" placeholder="Search">
                            </div>
                            <div class="col-md-3">
                                <input type="date" name="end" class="form-control float-right" value="<?php echo $end;?>" placeholder="Search">
                            </div>
                            <div class="col-md-3">
              ...
              <div class="export-table">
                  <a href="<?php echo base_url('Admin/Management/paidUsers?export=xls'); ?>" class="export-btn btn-primary"><img src="<?php echo base_url('NewDashboard/');?>assets/images/xls.png">Export to xls</a>
                  <a href="<?php echo base_url('Admin/Management/paidUsers?export=csv'); ?>" class="export-btn btn-success"><img src="<?php echo base_url('NewDashboard/');?>assets/images/csv.png">Export to csv</a>
                  <a href="<?php echo base_url('Admin/Management/paidUsers?export=txt'); ?>" class="export-btn btn-info "><img src="<?php echo base_url('NewDashboard/');?>assets/images/txt.png">Export to txt</a>
              </div>
              <!-- /.card-header -->
