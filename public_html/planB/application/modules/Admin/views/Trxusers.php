      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <span class="">TRX History</span>
            </section>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">TRX History</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
                    ...
                    <?php
                      ...
                      foreach ($users as $key => $transaction) {
                          ...
                          <tr>
                              ...
                              <td><?php if($transaction['transfer_status'] == 0){ echo '<a href="'.base_url('Admin/Settings/checkTrx').'" class=" btn btn-success">Check Trx Balance</a><br><a href="'.base_url("Admin/settings/deposit_trx").'" class=" btn btn-danger">Deposit Trx Balance</a><br><a href="" class=" btn btn-warning">Check Usdt Balance</a><br><a href="" class=" btn btn-info">Debit Admin Usdt</a><br>'; }?></td>
