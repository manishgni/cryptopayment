      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <span class="">Paid Members Datewise Reports</span>
            </section>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Paid Members Datewise Reports</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-header">
                  <form method="GET" action="<?php echo base_url('Admin/Management/paidDatewise/');?>">
                      <div class="row">
                                   <div class="col-md-3">
