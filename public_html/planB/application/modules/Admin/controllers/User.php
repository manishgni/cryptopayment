    ...
    public function Directs() {
        if (is_logged_in()) {
            ...
            foreach ($response['users'] as $key => $user) {
                ...
                $response['users'][$key]['directs'] = $this->User_model->get_single_record('tbl_users', array('spnser_id' => $user['user_id'] , 'paid_status' => 1 ), 'ifnull(count(id),0) as directs')['directs'];
            }
