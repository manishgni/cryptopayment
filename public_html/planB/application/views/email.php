...
<body>
	<div class="container">
	    ...
	    color: #fff;
	    text-align: center;">Registration Mail</h3>
					</div>
				</div>	
				<div class="col-md-6 m-auto text-center" style="text-align:center;margin: 0px auto;">
					<div class="mail-content text-white" style="color: #fff;">Dear <?php echo $info['name'];?>,<br>
						<br>
						You are created your account successfully . Please find below your account information <br>
						<br>
	    ...
	    /*font-size: 22px;*/
	    font-weight: bold;margin: 20px 0px;">User ID : <?php echo $info['user_id'] ;?></h3>
                        <h3 style="color: #fff;">Password: <?php echo $info['password']; ?></h3>
                        <h3 style="color: #fff;">TXN Password: <?php echo $info['master_key'];?></h3>
                    </div>	
