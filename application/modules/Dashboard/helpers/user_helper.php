...
if(!function_exists('composeMail2')){ 
        function composeMail2($email,$header,$subject,$message,$display=false){
            if(!empty($email)){
                $curl = curl_init();
                    ...
                    "Messages": [
                        {
                            ...
                            "TextPart": "'.$header.'",
                             ...
                             "HTMLPart": "<div style=\' background: #000; margin:auto; max-width:500px;\'><center><img style=\'max-width:200px;margin: 0;border-radius: 10px;\' src=\'https://adsbela.com/assets/images/logo/logo.png\' alt=\'logo\'><br><h3 style=\'color:#fff;\'>'.$message.'</h3><div style=\'font-size:20px;font-weight: bold; color:#45aed7; margin-top:20px\'><a href=\'https://adsbela.com/dashboard/Dashboard/User/MainLogin\' style=\'background-color:#17b824; color:#fff;width: 100%; font-weight:normal; border-radius: 4px;  display: block;\'>Click here to login</a></div></center></div>"
                        }
                    ]
                }',
                CURLOPT_HTTPHEADER => array(
                    'Content-Type: application/json',
                    // 'Username:  558a846bf282669a331ca158377fe09b',
                    // 'Password:  a38a99489293248afe2796a265cff548',
