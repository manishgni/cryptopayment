                    ...
                    <li>
                        <div class="member-img">
                            <a href="<?php echo base_url('Dashboard/User/Tree/' . $user['user_id']); ?>">
                                <img src="https://scootpool.uk/<?php echo $user['paid_status'] == 1 ? 'active' : 'inactive';?>.png">
                            </a>
                                ...
                                <li>
                                    <div class="member-img">
                                        <a href="<?php echo base_url('Dashboard/User/Tree/' . $direct['user_id']); ?>">
                                            <img src="https://scootpool.uk/<?php echo $direct['paid_status'] == 1 ? 'active' : 'inactive';?>.png">
                                        </a>
                                            ...
                                            <li>
                                                <div class="member-img">
                                                    <a href="<?php echo base_url('Dashboard/User/Tree/' . $sub_direct['user_id']); ?>">
                                                        <img src="https://scootpool.uk/<?php echo $sub_direct['paid_status'] == 1 ? 'active' : 'inactive';?>.png">
                                                    </a>
