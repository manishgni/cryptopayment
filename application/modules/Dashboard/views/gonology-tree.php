                                                    ...
                                                    <tr id="p0">
                                                        ...
                                                        <td colspan="2" align="center">
                                                            <a href="#" class="has-tooltip">
                                                                <img src="<?php echo base_url('SiteAssets/treeimage');?>/tree.png" alt="<?php echo $level1->name;?>" border="0" width="60">
                                                                <span class="on-hover">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr align="center" valign="top">
                                                                                        ...
                                                                                        if(!empty($level4[7]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.tree_img($level4[7]->package_amount,0).'" class="has-tooltip">
                                                                                                        <img src="'.base_url('SiteAssets/treeimage/tree.png').'" alt="'.$level4[7]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
                                                                                        ...
                                                                                        if(!empty($level4[8]->user_id)){
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.tree_img($level4[8]->package_amount,0).'" class="has-tooltip">
                                                                                                        <img src="'.base_url('SiteAssets/treeimage/tree.png').'" alt="'.$level4[8]->name.'" border="0" width="60">
                                                                                                        <span class="on-hover">
