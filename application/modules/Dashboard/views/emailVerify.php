                            ...
                            <div class="col-12 col-md-12 columns">
                                <div class="form-wrapper">
                                    ...
                                    <div class="page-header text-center">
                                        ...
                                        <p class="small">Please enter your Verification Code!</p>
                                    </div>
                                    <div class="panel panel-primary">
                                            ...
                                            <div class="panel-body">
                                                <div class="details password-form">
                                                  ...
                                                  <?php echo form_open(base_url('Dashboard/User/emailVerify')); ?>
                                                          ...
                                                          <fieldset>
                                                              <div class="form-group">
                                                                  ...
                                                                  <div class="row-holder">
                                                                      <input id="" type='text' name='otp'  class="form-control" placeholder="Enter Code"/>
                                                                  </div>
                                                              </div>
                                                              <div class="form-group" style="text-align: right; padding-right: 18px;">
                                                                  <button id="signupBtn" type="submit" class="btn btn-gredient btn-block" name='Submit' value='Login'>Verify </button>
                                                              </div>
