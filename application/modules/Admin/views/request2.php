      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <h2><?php echo $this->session->flashdata('message');?></h2>
                ...
                <div class="form-group">
                    <label>Amount</label>
                    <input type="text" name="amount" value="<?php echo round($request['payable_amount']*dollar_price); ?>"  class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Type</label>
                    <input type="text" name="type" value="<?php echo $request['type']; ?>"  class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label>Remark</label>
                ...
                <div class="form-group">
                    <button class="btn btn-success pull-right" type="Submit" >Transfer Money</button>
                </div>
                <?php echo form_close(); ?>
          </div>
        </div>
