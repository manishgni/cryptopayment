            ...
            <nav class="mt-2">
               <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item has-treeview">
                     ...
                     <ul class="nav nav-treeview" style="display: none;">
                        <li class="nav-item">
                           <a href="<?php echo base_url('Admin/Management/addBlockchain');?>" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Add BlockChain</p>
                           </a>
                        </li>
                          <li class="nav-item">
                           <a href="<?php echo base_url('Admin/Management/blockchainList');?>" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>BlockChain List</p>
                           </a>
                        </li>
                  ...
                  <li class="nav-item has-treeview">
                     ...
                     <ul class="nav nav-treeview" style="display: none;">
                        <li class="nav-item">
                           <a href="<?php echo base_url('Admin/Management/addtoken');?>" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Add Token</p>
                           </a>
                        </li>
                        <li class="nav-item">
                           <a href="<?php echo base_url('Admin/Management/tokenList');?>" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Token List</p>
                           </a>
                        </li>
